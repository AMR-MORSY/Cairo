...
class DownAlarmsImport implements ToModel ,WithHeadingRow ,WithBatchInserts ,WithChunkReading,WithValidation
{
    ...
    */
    ...
    public function rules(): array
    {
        return [
            ...
            "*.Alarm Name" => ["required", "regex:/^(OML Fault)|(NodeB Unavailable)$/"],
